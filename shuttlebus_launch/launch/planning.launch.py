...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        freespace_planner_param, vehicle_characteristics_param,
        behavior_planner, lanelet2_global_planner, lane_planner,
        mpc_controller, object_collision_estimator, costmap_generator,
        freespace_planner
    ])
